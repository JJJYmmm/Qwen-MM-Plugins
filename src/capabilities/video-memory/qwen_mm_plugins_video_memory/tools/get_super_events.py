...
def handle(arguments: dict[str, Any]) -> list[dict[str, Any]]:
    """List all Super Events (high-level narrative arcs). Each entry has: super_id, label, time_range, key_entities, description, num_macros. When to use: You need to understand the overall structure of the video, identify which story arc is relevant, or the user asks about the video's main sections or chapters."""
