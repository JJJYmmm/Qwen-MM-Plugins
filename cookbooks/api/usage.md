...
for local audio/video processing. See [installation](../../docs/en/installation.md) for other hosts.
...
See [configuration](../../docs/en/configuration.md) for all settings.
...
See the [API Skill](../../src/capabilities/api/skill/SKILL.md) and MCP tool schemas for arguments.
...
[View an image-understanding workflow](https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen-MM-Plugins/asserts/core/case-core-codex-api-use.html).

The following examples use files in [`assets/`](assets/). See [asset sources](assets/SOURCES.md).
